...
public class ReturnStatementTest {
    ...
    @Test
    public void returnIntNode() throws IOException, InvalidTokenException, UnexpectedTokenException, UndefinedReferenceException, RuntimeEnvironmentException {
    ...
    @Test
    public void returnDoubleNode() throws IOException, InvalidTokenException, UnexpectedTokenException, UndefinedReferenceException, RuntimeEnvironmentException {
    ...
    @Test
    public void returnVariableWithCurrency() throws IOException, InvalidTokenException, UnexpectedTokenException, UndefinedReferenceException, RuntimeEnvironmentException {
